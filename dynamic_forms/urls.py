...
urlpatterns = patterns('',
    ...
    url(r'^change_order/(?P<field_id>\d+)/(?P<direction>-?\d+)/$',
     views.ChangeFieldOrder.as_view(),  name="dynamic_forms.views.change_field_order"),

    url(r'^fill/(?P<dynamic_form_id>\d+)/$', views.FillForm.as_view(), name='dynamic_forms.views.fill_form'),

    url(r'^list/(?P<dynamic_form_id>\d+)/$', views.ParticipantList.as_view(), name="dynamic_forms.views.participants_list"),
